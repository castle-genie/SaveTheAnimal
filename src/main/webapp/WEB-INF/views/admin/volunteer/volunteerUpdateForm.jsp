...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	...
	<div class="container">
	 ...
	 <form id="updateForm">
        ...
        <input type="number" id="volunteerLimit" name="volunteerLimit" value="${ updateList.volunteerLimit }"><br><br>
        
        <label for="volunteerCost">봉사활동 비용:</label><br>
        <input type="text" id="volunteerCost" name="volunteerCost" value="${ updateList.volunteerCost }"><br><br>
...
<script src="/resources/include/js/volunteer/volunteerUpdate.js"></script>
</body>
</html>
