...
<html lang="en" data-bs-theme="auto">
  <head><script src="/resources/include/assets/js/color-modes.js"></script>
	...
	<link href="/resources/include/assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
	...
	<main class="form-signin w-100 m-auto">
	  ...
	  <form id="loginForm">
	    ...
	    <button class="btn btn-primary w-100 py-2" type="button" id="loginBtn">Sign in</button>
