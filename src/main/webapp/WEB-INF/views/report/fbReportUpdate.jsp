			...
			<div class="modal-body">
				...
				<form id="f_data">
					...
					<fieldset>
						...
						<textarea style="width: 100%; height: 10em; resize: none;" class="form-control" placeholder="신고 내용을 기입해 주세요" id="reportDetail" name="reportDetail">${freeBoard.reportDetail}</textarea>
					</fieldset>
				</form>
			</div>
