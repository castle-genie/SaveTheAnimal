		...
		<div class="inner">
			<div class="box">
				<div class="content">
					...
					<form method="post" action="/noticeBoard/noticeBoardModify">
						<div class="row uniform">
							<div class="12u$">
								<input type="hidden" name="nboardId" id="nboardId" value="${noticeBoard.nboardId}">
							</div>
							<div class="12u$">
								<input type="text" name="nboardTitle" id="nboardTitle" placeholder="제목" 
								value="${noticeBoard.nboardTitle}">
							</div>
							<div class="12u$">
								<textarea cols="100" wrap="hard" name="nboardContent" id="nboardContent" placeholder="내용을 입력해주세요"
									rows="6">${noticeBoard.nboardContent}</textarea>
							</div>
							<div class="12u$">
