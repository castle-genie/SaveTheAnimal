				...
				<div class="content">
					...
					<ul class="actions text-end">
						...
						<c:if test="${not empty userLogin}">
							<c:choose>
								<c:when test="${volunteerFeedbackBoard.reUserId eq userLogin.userId}">
									<li><%@ include file="/WEB-INF/views/report/vbReportUpdate.jsp"%></li>
								</c:when>
								<c:otherwise>
									<li><%@ include
											file="/WEB-INF/views/report/vbReportInsert.jsp"%></li>
								</c:otherwise>
