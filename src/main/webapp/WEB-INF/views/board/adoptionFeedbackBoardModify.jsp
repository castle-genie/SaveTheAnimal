		...
		<div class="inner">
			<div class="box">
				<div class="content">
					...
					<form method="post" action="/adoptionFeedbackBoard/adoptionFeedbackBoardModify">
						<div class="row uniform">
							<div class="12u$">
								<input type="hidden" name="afboardId" id="afboardId" value="${adoptionFeedbackBoard.afboardId}">
							</div>
							<div class="12u$">
