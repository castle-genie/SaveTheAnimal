...
<link rel="stylesheet" type="text/css"
	href="/resources/include/css/donate/donatePay.css" />
		...
		<div id="donate_pay" class="donatePay_data">
			...
			<form>
				...
				<table class="priceSelect">
					...
					<tbody>
						<tr>
							<td><label><input type="radio" name="do_price"
									value="10000" class="price_Select">10,000원</label></td>
							<td><label><input type="radio" name="do_price"
									value="20000" class="price_Select">20,000원</label></td>
							<td><label><input type="radio" name="do_price"
									value="30000" class="price_Select">30,000원</label></td>
						</tr>
						<tr>
							<td><label><input type="radio" name="do_price"
									value="40000" class="price_Select">40,000원</label></td>
							<td><label><input type="radio" name="do_price"
									value="50000" class="price_Select">50,000원</label></td>
							<td><label><input type="radio" name="do_price"
									value="Select" class="price_Select">직접입력</label></td>
							<!-- 텍스트 누를시 다른 체크 박스 강제 아웃 시켜야 한다. -->
						</tr>
						<tr>
							<td colspan="3"><label for="do_price"><input
									type="text" id="do_price" name="do_price" class="input_Select">원</label></td>
						</tr>
					</tbody>
				</table>
				<div class="warning">
				...
				<table class="priceData">
					...
					<tbody>
						<tr>
							<th>결제 수단</th>
							<td><input type="text" id="do_PM"value="카드결제" readonly></td>
						</tr>
						<tr>
							<th>카드 주명</th>
						...
						<tr>
							<th>카드주 휴대폰</th>
							<td><input type="text" id="do_AHPhone"
								placeholder="' - '없이 입력해주세요" maxlength="11"></td>
						</tr>
					</tbody>
				</table>
				<div class="warning">
				...
				<div class="Privacy_Check">
					<label for="Privacy_Check1"><input type="checkbox"
						id="Privacy_Check1" name="Privacy_Check1" required>개인정보 수집
						이용약관의 동의합니다.</label>
			...
			<button class="donatePayBtn" id="donate_pay_Btn">결제하기</button>
			<!-- FORM에 안들어감 -->
		</div>
