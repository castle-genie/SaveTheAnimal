$(function(){	
	...
	$("#searchBtn").on("click", function(e){
		...
		actionProcess("#searchForm", "get", "/volunteerFeedbackBoard/volunteerFeedbackBoardList");
		goPage();
	});
	
	
	$("#allSearchBtn").on("click", function(){
		locationProcess("/volunteerFeedbackBoard/volunteerFeedbackBoardList");
	});
	...
	$(".page-item a").on("click", function(e){
		...
		actionProcess("#pageNum", "get", "/volunteerFeedbackBoard/volunteerFeedbackBoardList");
	});
