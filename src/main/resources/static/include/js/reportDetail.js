		...
		$.ajax({
			...
			success:function(){
				if(boardSort == fboard){
					$.ajax({
						type:"post",
						url:"/admin/report/reportUpdateFB",
						data:$("#f_data").serialize(),
						success:function(){
							console.log("test");
							$("f_data").attr({
					...
					$.ajax({
						type:"post",
						url:"/admin/report/reportUpdateVB",
						data:$("#f_data").serialize(),
						success:function(){},
						error:function(){}
					})
					...
					$.ajax({
						type:"post",
						url:"/admin/report/reportUpdateAB",
						data:$("#f_data").serialize(),
						success:function(){},
						error:function(){}
					})
					...
					$.ajax({
						type:"post",
						url:"/admin/report/reportUpdateFC",
						data:$("#f_data").serialize(),
						success:function(){},
						error:function(){}
					})
					...
					$.ajax({
						type:"post",
						url:"/admin/report/reportUpdateVC",
						data:$("#f_data").serialize(),
						success:function(){},
						error:function(){}
					})
					...
					$.ajax({
						type:"post",
						url:"/admin/report/reportUpdateAC",
						data:$("#f_data").serialize(),
						success:function(){},
						error:function(){}
					})
